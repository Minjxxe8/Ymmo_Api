...
public class MethodFilter extends OncePerRequestFilter {
    ...
    public MethodFilter(JWTUtils jwtUtils, UsersRepository usersRepository) {
        ...
        try {
            if (HttpMethod.POST.matches(request.getMethod()) || HttpMethod.PATCH.matches(request.getMethod()) || HttpMethod.DELETE.matches(request.getMethod())) {
                ...
                if (user.getAuthorities().stream()
                        ...
                        .noneMatch(value -> Objects.equals(value.getAuthority(), "ROLE_admin") || Objects.equals(value.getAuthority(), "ROLE_agent"))) {
